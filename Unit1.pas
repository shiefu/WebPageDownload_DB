...
type
  TForm1 = class(TForm)
    ...
    procedure tmr_cleardataTimer(Sender: TObject);
  private
...
procedure TForm1.tmr_cleardataTimer(Sender: TObject);
begin
  clearData;
end;
...
begin
  writeMemo(soccer, '開始清理資料庫.....................');
  writeMemo(nba, '開始清理資料庫.....................');
  msp_ClearData.ParamByName('pSport').AsString:='soccer';
  msp_ClearData.ExecProc;
  writeMemo(soccer, '資料庫清理完成，只保留最新50次');
  writeMemo(nba, '資料庫清理完成，只保留最新50次');
end;
